...
- **Implementation Artifacts:** All `implementation_plan.md` and `task.md` MUST be written in professional Technical English. Failure to do so triggers a refactoring of the documentation.
