...
| :--- | :--- | :--- |
| **0. Amnestic Anchor** | `init_check` | All executing subagents initialize with zero memory; the constitution arrives auto-imported (no re-read — `anti_amnesia`). Coordinator is `Rule Validator`. |
