...
| **2. Benchmarking**| `skillopt_run` | Optimize new `SKILL.md` via `skills/skillopt/scripts/train_runner.py` (requires explicit authorization). Done-criterion: exit `0`. If SkillOpt is not installed, record "skillopt_run skipped: skillopt stack absent" and continue. |
