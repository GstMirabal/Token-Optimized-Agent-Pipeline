...
| **Golden Gate** | `pre_approval_audit` | Audits a candidate Implementation Plan before Golden Gate, applying Filter 5 to every proposed recurring mechanism. |
