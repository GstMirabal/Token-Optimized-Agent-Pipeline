<!-- BANNER_START -->
<p align="center">
  <img src="{{BANNER_PATH}}" width="100%" height="200">
</p>
<!-- BANNER_END -->
...
| **§7** | Rule Amendments | `RA-01`…`RA-18` amendments, including Branch Discipline (RA-12). |
...
### 4. Command Reference
For the full catalog of slash commands, see `docs/guides/AGENTS_SLASH_COMMANDS_GUIDE.md`.
...
[x-url]: {{OWNER_X_URL}}
[contributors-shield]: https://img.shields.io/github/contributors/{{REPO_SLUG}}.svg?style=for-the-badge
[contributors-url]: {{REPO_URL}}/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/{{REPO_SLUG}}.svg?style=for-the-badge
[forks-url]: {{REPO_URL}}/network/members
[stars-shield]: https://img.shields.io/github/stars/{{REPO_SLUG}}.svg?style=for-the-badge
[stars-url]: {{REPO_URL}}/stargazers
[issues-shield]: https://img.shields.io/github/issues/{{REPO_SLUG}}.svg?style=for-the-badge
[issues-url]: {{REPO_URL}}/issues
[license-shield]: https://img.shields.io/github/license/{{REPO_SLUG}}.svg?style=for-the-badge
[license-url]: {{REPO_URL}}/blob/main/LICENSE.txt
[release-shield]: https://img.shields.io/github/v/release/{{REPO_SLUG}}?style=for-the-badge
[release-url]: {{REPO_URL}}/releases
