...
- **Next / in flight:** **`036`** (M/L). Then G → **037**; family-trial → **038**. Hosts: first re-enable was manual pin of **`v4.17.0`**; from **035** `/start` auto-pins. **`035` closing** this seal. `034` **deployed** `v4.17.0` (PR #66, 2026-08-26). `033` **deployed** `v4.16.0` (PR #65, 2026-08-25). `032` **deployed** `v4.15.0` (PR #64). `031` **deployed** `v4.14.0` (PR #63). H-004 **deployed** `v4.13.1` (PR #62).
