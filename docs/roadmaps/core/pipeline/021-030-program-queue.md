...
- **Next / in flight:** `030` (`token-economy-enforcement`) on `ai-sprint/030`. `029` **deployed** `v4.12.0` (PR #59 + seal, 2026-08-25). `F-026-A2` closed in 030. `F-021-A2` remains open. **`F-093-G1`** carried → `031` `gate-verdict-classes`. First author-tier model trial: **declared for 031** (`docs/guides/MODEL_TIER_TRIAL_GUIDE.md`).
...
| **1st** | **030** | `token-economy-enforcement` | In flight on `ai-sprint/030`. Auditor body + consumption trigger + `check_task_scope.py` (`F-026-A2`); trial guide; first author-tier trial → 031 |
