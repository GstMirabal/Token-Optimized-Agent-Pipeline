...
- **Next / in flight:** **`036`** (M/L — executed, awaiting close). Then **037** = Track **G** (ledger) + rider **S** (Cursor-agent sandbox false reds: `make verify` `xargs`/`ARG_MAX`, nucleus `.bridge_cursor.lock`). Then family-trial → **038**. Hosts pin via `/start` auto-pin to newest `v*`. **`035` deployed** `v4.18.0` (PR #67, 2026-08-26). `034` **deployed** `v4.17.0` (PR #66, 2026-08-26). `033` **deployed** `v4.16.0` (PR #65, 2026-08-25). `032` **deployed** `v4.15.0` (PR #64). `031` **deployed** `v4.14.0` (PR #63). H-004 **deployed** `v4.13.1` (PR #62).
