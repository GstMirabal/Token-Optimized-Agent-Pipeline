...
- **Next / in flight:** **`038`** = family-trial — **promote sealed** on `ai-sprint/038` (`cursor.author` → **`glm-5.2`** / `zhipu` / `high`; D16 `GATE_REPLAY.md` recorded); awaiting `/agents:close` + deploy. Program **034–038** otherwise complete; no next nucleus program slot named. Hosts pin via `/start` auto-pin to newest `v*`. **`037` deployed** `v4.20.0` (PR #69, 2026-08-26). **`036` deployed** `v4.19.0` (PR #68, 2026-08-26). **`035` deployed** `v4.18.0` (PR #67, 2026-08-26). `034` **deployed** `v4.17.0` (PR #66, 2026-08-26). `033` **deployed** `v4.16.0` (PR #65, 2026-08-25). `032` **deployed** `v4.15.0` (PR #64). `031` **deployed** `v4.14.0` (PR #63). H-004 **deployed** `v4.13.1` (PR #62).
