...
| A3 | `docs/sprints/026-core-pipeline/SPRINT_LOG.md` | modify | medium | `orchestrator` (transcribe el veredicto de `qa_agent`; `Design §D9`) | — (es la puerta) | ✅ A3 failed ID; A3.1+A3.r passed — portability affirmable |
