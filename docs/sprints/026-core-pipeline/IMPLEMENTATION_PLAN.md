...
| A3 | `docs/sprints/026-core-pipeline/SPRINT_LOG.md` | modify | medium | `orchestrator` (transcribe el veredicto de `qa_agent`; `Design §D9`) | — (es la puerta) | ✅ — judge ID'd `cursor_mdc_schema.md`; portability not affirmed |
