# 📄 Contract: Topology Mapper Interface (topology_mapper_01)

This contract defines the technical interface and I/O expectations for the **Topology Mapper** agent. It standardizes the scaffolding and state-synchronization handover.

| Phase | Input | Action | Output | Status |
| :--- | :--- | :--- | :--- | :--- |
| **Initiation** | `agents.md` | Ruleset Audit | Alignment Signature | MANDATORY |
...
## 1. Documentation Entry Point Payload (active_state.json)

| Parameter | Type | Required | Description |
| :--- | :--- | :--- | :--- |
| `active_layer` | String | Yes | The current functional tier of the pipeline. |
...
The Topology Mapper MUST issue a high-fidelity signature in the `topology_map.md` to trigger the **Discovery Lock (Sync-Lock)**.
- **Format**: `ef3c429d-pipeline-v3.0-verified`
