...
Version: 1.1.0 | **VERIFIED_TOPOLOGY_SIG:** ef3c429d-matrix-v3.0-verified
...
| **`governance/`** | Universal-Core | Rules 1-81 and Constitution. | ✅ PROTECTED |
| **`workflows/`** | Custom-Hardened | Refactored execution manuals and protocols. | ✅ ALIGNED |
| **`knowledge/`** | Universal-Persist | Long-term memory (Knowledge Items). | ✅ INDEXED |
| **`skills/`** | Universal-Arsenal | Validated binary and quality tools. | ✅ AUDITED |
| **`agents/`** | Core-Intelligence | Subagent profiles and operational roles. | ✅ PROTECTED |
| **`scripts/`** | Utility-Buffer | Internal maintenance and audit scripts. | ✅ ALIGNED |
...
- **`extract_workflow.md`**: Heuristic distillation and memory update.
