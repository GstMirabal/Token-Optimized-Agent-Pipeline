...
description: Django Backend & Authentication Developer. Use this agent for backend APIs, serializers, and Django data models related to identity under backend/apps/users/, applying the Lazy Signal Paradigm (J-02) in signals.py and strict ruff/type-hint compliance.
...
| **Execution** | `lazy_signal` | MUST use the Lazy Signal Paradigm (`J-02`) to prevent circular dependencies in `signals.py`. |
