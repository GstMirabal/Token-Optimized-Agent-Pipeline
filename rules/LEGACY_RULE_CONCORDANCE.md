...
| **Rule 60** | `agents.md §3 trinity_standard` | (Dual) Trinity Standard for skills. |
| **Rule 66** | `agents.md §3 secret_sovereignty` + `J-09` | Never read `.env` into context; secret shielding. |
...
| **Rule 79** | `agents.md §4 definitive_amnesia` | Log purge after constitutionalization. |
