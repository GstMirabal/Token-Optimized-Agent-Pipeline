...
<!-- COUNTED_START -->
| **Infrastructure** | 32 Python scripts in [`scripts/`](scripts/) · 6 JSON registries in [`config/`](config/) |
<!-- COUNTED_END -->

| | |
| :--- | :--- |
| **Governance** | Keyed ruleset in [`agents.md`](agents.md) + 11 lazy-loaded domain rule contexts in [`rules/`](rules/) |
| **Subagents** | 14 role-segregated agents in [`agents/`](agents/) — 8 core pipeline roles, 6 auxiliary |
